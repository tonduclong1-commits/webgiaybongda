...
<div style="background-color: var(--white); border: 1px solid var(--border-color); box-shadow: var(--shadow); border-radius: var(--radius); padding: 35px; max-width: 800px; margin: 0 auto;">
    ...
    <!-- enctype is critical for file upload! -->
    <form action="index.php?act=sanpham-add" method="POST" enctype="multipart/form-data">
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            ...
            <div class="form-group" style="grid-column: span 2;">
                ...
                <input type="text" name="ten_sanpham" id="ten_sanpham" class="form-control" 
                       placeholder="Ví dụ: Nike Mercurial Superfly 9 Elite..." required>
            </div>
            ...
            <div class="form-group">
                ...
                <span style="font-size: 11px; color: var(--text-muted);">Định dạng hợp lệ: JPG, PNG, GIF, SVG, WEBP. Để trống sẽ dùng ảnh mặc định.</span>
            </div>

            <!-- Price -->
            <div class="form-group">
                <label for="gia">Giá niêm yết (đ) <span style="color: var(--danger)">*</span></label>
                <input type="number" name="gia" id="gia" min="0" class="form-control" placeholder="Ví dụ: 2500000" required>
            </div>

            <!-- Discount Price -->
            <div class="form-group">
                <label for="gia_giam">Giá khuyến mãi (đ) (nếu có)</label>
                <input type="number" name="gia_giam" id="gia_giam" min="0" class="form-control" placeholder="Ví dụ: 1990000">
            </div>
            ...
            <div class="form-group" style="grid-column: span 2;">
                ...
                <textarea name="mo_ta" id="mo_ta" rows="6" class="form-control" style="resize: vertical; min-height: 120px;" placeholder="Mô tả chất liệu, phom chân, công nghệ đế đệm..."></textarea>
            </div>
        </div>
